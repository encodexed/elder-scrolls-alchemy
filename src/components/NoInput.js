		...
		<div className='border'>
			<Card>
				<div className='flex flex-col'>
					{/* <h2 className='text-2xl leading-none text-center text-black'>
					...
					<div className='flex flex-col leading-none'>
						<p className='text-pink-500'>
							<img
								...
								alt='Mountain Flower'
							/>
							Welcome to the ESO Alchemy Assistant. This tool aims to
							help you craft potions and poisons in the game Elder
							Scrolls Online.
						</p>
						<p className='mt-3 text-sky-500'>
							<img
								...
								alt='Columbine'
							/>
							You can choose to select ingredients or effects to generate
							a potion/poison. Choosing effects will output a list of
							possible combinations for your desired potion.
						</p>
						<p className='mt-3 text-lime-500'>
							<img
								className='inline w-5 h-5'
